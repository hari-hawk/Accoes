...
export default function PreviewCoverPageV3() {
  ...
  const [alternativeSpecTitles] = useState<Set<string>>(() => {
      ...
      <div className="shrink-0 border-t bg-background/95 backdrop-blur-sm">
        <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-end">
          <Button
            ...
            onClick={() =>
              router.push("/project-v3/submittal-binder")
            }
          >
