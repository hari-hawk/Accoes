...
export function V4ConformanceSection() {
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      {/* Bottom panel — Proceed CTA */}
      <div className="shrink-0 border-t bg-card dark:bg-card px-4 sm:px-6 lg:px-12 py-2.5 flex items-center justify-end shadow-[0_-4px_12px_-2px_rgba(0,0,0,0.08)] dark:shadow-[0_-4px_12px_-2px_rgba(0,0,0,0.3)]">
        <Button
          className={cn(
            "shrink-0",
            reviewedIds.size > 0
