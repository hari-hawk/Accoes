...
export const piValidations: ValidationResult[] = [
  {
    ...
    indexMatches: [
      {
        id: "im-1",
        category: "Hangers, Supports & Hardware",
        subCategory: "Finishes",
        itemDescription: "Electro-galvanized finish 0.3 mil thickness, ASTM B633 compliant",
        size: "Standard",
        matchType: "EXACT",
        matchScore: 0.98,
        reason: "Exact match on category, sub-category, and item description. Coating thickness exceeds minimum baseline by 50%. This is a Standard material.",
      },
    ],
  },
  {
    ...
    indexMatches: [
      {
        id: "im-2a",
        category: "Hangers/Supports",
        subCategory: "Clevis",
        itemDescription: "Clevis pipe hanger Type 1, carbon steel galvanized, MSS SP-58",
        size: "2.5\" thru 18\"",
        matchType: "PARTIAL",
        matchScore: 0.82,
        reason: "Exact match on category and sub-category. Safety factor 3.5 vs required 4.0 for seismic zones. Static load capacity adequate per MSS SP-69.",
      },
      {
        id: "im-2b",
        category: "Hangers/Supports",
        subCategory: "J Hanger",
        itemDescription: "J-type pipe hanger for horizontal piping, insulation protection shield included",
        size: "2.5\" | 3\"",
        matchType: "PARTIAL",
        matchScore: 0.68,
        reason: "Alternate hanger type in same category. J-hanger applicable for 2.5-3 inch range only. Suitable for accessible ceiling spaces but limited size range.",
      },
      {
        id: "im-2c",
        category: "Hangers/Supports",
        subCategory: "Channel Strut",
        itemDescription: "Steel channel strut (Unistrut P1000), trapeze hangers and equipment mounting",
        size: "Varies",
        matchType: "ALTERNATE",
        matchScore: 0.55,
        reason: "Alternate support method in same category. Channel strut used for trapeze assemblies rather than individual pipe support. Different application but related sub-category.",
      },
    ],
  },
  {
    ...
    indexMatches: [
      {
        id: "im-3a",
        category: "Hangers/Supports",
        subCategory: "Riser Clamps",
        itemDescription: "Riser clamp Type 8, carbon steel, vertical load capacity 800 lbs",
        size: "Standard",
        matchType: "PARTIAL",
        matchScore: 0.48,
        reason: "Exact match on category and sub-category. Vertical load capacity 800 lbs vs baseline 1,200 lbs (-33%). Fails minimum performance threshold.",
      },
      {
        id: "im-3b",
        category: "Specialties",
        subCategory: "Roof Penetrations",
        itemDescription: "ACCO engineered roof penetration assembly for piping through roof membrane",
        size: "Varies",
        matchType: "ALTERNATE",
        matchScore: 0.35,
        reason: "Different category match. Riser clamp assembly includes roof penetration components. The material category differs from the submittal category 'Hangers/Supports'. This is an Alternate material.",
      },
    ],
  },
  {
    ...
    indexMatches: [
      {
        id: "im-4",
        category: "Hangers/Supports",
        subCategory: "Pipe Strap",
        itemDescription: "Standard pipe strap Type 26, load capacity 500 lbs, galvanized finish",
        size: "Standard",
        matchType: "EXACT",
        matchScore: 0.90,
        reason: "Exact match on category, sub-category, and item description. Load capacity exceeds baseline by 25%. This is a Standard material.",
      },
    ],
  },
];
